...
public class OrganizationUnitAppService : IdentityAppServiceBase, IOrganizationUnitAppService
{
    ...
    protected Zoey.Identity.IIdentityRoleRepository RoleRepository { get; }
    protected Zoey.Identity.IIdentityUserRepository UserRepository { get; }

    public OrganizationUnitAppService(
        IdentityUserManager userManager,
        Zoey.Identity.IIdentityRoleRepository roleRepository,
        Zoey.Identity.IIdentityUserRepository userRepository,
    ...
    [Authorize(IdentityPermissions.OrganizationUnits.ManageRoles)]
    public async Task RemoveRolesAsync(Guid roleId, Guid ouId)
    {
    ...
    [Authorize(IdentityPermissions.OrganizationUnits.ManageUsers)]
    public async Task RemoveUsersAsync(Guid userId, Guid ouId)
    {
