...
public class OrganizationUnitController : AdminController, IOrganizationUnitAppService
{
    ...
    {
        await OrganizationUnitAppService.RemoveRolesAsync(roleId, ouId);
    }
    ...
    [HttpDelete("{ouId}/users/{userId}")]
    public async Task RemoveUsersAsync(Guid userId, Guid ouId)
    {
        await OrganizationUnitAppService.RemoveUsersAsync(userId, ouId);
    }
