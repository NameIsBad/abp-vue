...
public class IdentityUserController : AdminController, IIdentityUserAppService
{
    ...
    public virtual async Task ChangePasswordAsync(Guid id, ChangePasswordDto input)
    {
