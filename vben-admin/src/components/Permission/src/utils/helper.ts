...
import { PermissionGroupDto, UpdatePermissionDto } from '/@/api/proxy/permission-management';
import { listToTree } from '/@/utils/helper/treeHelper';

export function generatePermissionTree(permissionGroups: PermissionGroupDto[]) {
